function [TagsFound] = caltag_all(I,datafile,debug)
...
T = single(T); % Philippe Giguere, dec 2012. Some matlab function crapped out without this
if debug
...
isvalid=@(x)crc_validate(b2d(x),idBits,crcBits);
...
% This is philippe's modifications
return;
